  ...
  fluidPage(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        tags$ol(
          tags$li(
            "Each team has an integer cost determined by its seed in its region (see table below).  Periodically costs are revised.  The most recent revision was in 2019."
          ),
          tags$li(
            "Each contestant selects as many teams as he/she wants with costs totaling at most 200."
          ),
          tags$li(
            "Each contestant receives one point for each win by a team that he/she selects."
          ),
          tags$li(
            "The four play-in games do not count -- you buy the spot in the bracket and get the team that wins the play-in game but only score points starting with the round of 64."
          ),
          tags$li("The contestant with the most points wins."),
          tags$li(
            "In case of a tie, the winner is the contestant who scores the \"most points in
          ...
          tags$li(
            "Entries are due by the noon Eastern Time on the first day of the round of 64."
          )
        ),
        fluidRow(
          column(2),
      ...
      tabPanel(
        ...
        conditionalPanel(
          ...
          span(paste(
            "Welcome to the NCAA modeling competition.",
          ...
          fluidRow(
            column(
              ...
              conditionalPanel(
                ...
                helpText(
                  "The submit button won't appear until you have entered a name and email address.  Only one submission is allowed per email address. Each new submission will replace any previous submissions."
                )
              )
            )
          ),
          tabsetPanel(
            tabPanel(
              ...
              fluidRow(
                column(
                  3,
                  h4(textOutput("RegionNameW1")),
                  uiOutput("TeamsSelectorW1")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameW2")),
                  uiOutput("TeamsSelectorW2")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameW3")),
                  uiOutput("TeamsSelectorW3")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameW4")),
                  uiOutput("TeamsSelectorW4")
                )
              )
            ...
            tabPanel(
              ...
              fluidRow(
                column(
                  3,
                  h4(textOutput("RegionNameM1")),
                  uiOutput("TeamsSelectorM1")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameM2")),
                  uiOutput("TeamsSelectorM2")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameM3")),
                  uiOutput("TeamsSelectorM3")
                ),
                column(
                  3,
                  h4(textOutput("RegionNameM4")),
                  uiOutput("TeamsSelectorM4")
                )
              )
            ) # end men's tab panel
        ...
        fluidRow(
          column(
            ...
            conditionalPanel(
              ...
              helpText(
                "If you have administrative access, you should know how to unlock the door."
              ),
              ...
              span("R Bebej"),
              br(),
              strong("Honorary Commissioner & Historian:"),
              span("M Stob"),
              br()
            ),
            conditionalPanel(
